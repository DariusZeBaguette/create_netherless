...
public class CreateNetherlessModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATE_NETHERLESS_TAB = REGISTRY.register("create_netherless_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.create_netherless.create_netherless_tab")).icon(() -> new ItemStack(CreateNetherlessModItems.ECTOPLASM.get())).displayItems((parameters, tabData) -> {
				tabData.accept(CreateNetherlessModItems.COAL_ROD.get());
				tabData.accept(CreateNetherlessModItems.ECTOPLASM.get());
